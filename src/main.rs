...
fn load_title_font_atlas() -> FontAtlas {
    ...
    let glyph_widths = [
        (' ', 0.45),
        ('A', 0.45), ('B', 0.45), ('C', 0.45), ('D', 0.45), ('E', 0.45), ('F', 0.45),
        ('G', 0.45), ('H', 0.45), ('I', 0.45), ('J', 0.45), ('K', 0.45), ('L', 0.45),
        ('M', 0.45), ('N', 0.45), ('O', 0.45), ('P', 0.45), ('Q', 0.45), ('R', 0.45),
        ('S', 0.45), ('T', 0.45), ('U', 0.45), ('V', 0.45), ('W', 0.45), ('X', 0.45),
        ('Y', 0.45), ('Z', 0.45),
        ('g', 0.45), ('h', 0.45), ('i', 0.45), ('j', 0.45), ('k', 0.45), ('l', 0.45),
        ('a', 0.45), ('b', 0.45), ('c', 0.45), ('d', 0.45), ('e', 0.45), ('f', 0.45),
        ('m', 0.45), ('n', 0.45), ('o', 0.45), ('p', 0.45), ('q', 0.45), ('r', 0.45),
...
fn main() {
    ...
    let (
        ...
        &context, &title_font_atlas, "AA  ZZ", -0.75, 0.4, 280.0
    );
